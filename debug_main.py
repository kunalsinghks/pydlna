...
class PyDLNAGUI(ctk.CTk):
    def __init__(self):
        ...
        self.pass_btn = ctk.CTkButton(self.sidebar, text="Set Password", fg_color="transparent", border_width=1, border_color="#3b82f6", text_color="#3b82f6", command=self.set_password)
        self.pass_btn.grid(row=4, column=0, padx=20, pady=5)
